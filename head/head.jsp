			...
			<div class="col-md-10 col-md-offset-1">
				...
				<div class="navbar-header">
					...
					<a class="navbar-brand" href="${APP_PATH}/index.jsp">
						<img class="img_logo" alt="Brand" src="${APP_PATH}/static/img/logo-whut.png">
					</a>
				</div>
									...
									<li>
										<div class="row">
											<div class="col-xs-4 col-xs-offset-1">
												<a class="text-info" href="${APP_PATH}/userController/getMyself">我的主页</a>
											</div>

											<div class="col-xs-3">
												<a class="text-info" href="#" data-toggle="modal" data-target="#setup">设置</a>
											</div>
											
											<div class="col-xs-3">
												<a class="text-info" href="${APP_PATH}/userController/userExit">退出</a>
											</div>
										</div>
									</li>
								</ul>
