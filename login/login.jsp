...
<body>
							...
							<form id="register">
								<div class="form-group">
									<input type="text" class="form-control" name="name" id="name2"
										required="required" oninput="check_id(this)" placeholder="用户名">
									<font id="idError" color="red" ></font></td>
	...
	$("#login").submit(function(){
		...
		function check_id(obj){
						...
						var id_span = document.getElementById("idError");
						var idname_zz =  /^[^\u4e00-\u9fa5]+$/;
						var reg=/^[a-zA-Z0-9]{4,15}$/;
						if(obj.value.length < 1){
							//alert(1);
							id_span.innerHTML = "账号不能为空";
							
						}else if(!idname_zz.test(obj.value)){
							id_span.innerHTML = "账号不能包含汉字";
							
						}else if(!reg.test(obj.value))
						{
							id_span.innerHTML = "请输入4-15位长度字符";
